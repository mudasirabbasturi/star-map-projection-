...
const Main = ({ styles, setStyles, fontFamilies }) => {
  return (
    <>
      ...
      <hr className="mb-1 mt-1" />
      <div className="mb-2">Show/Hide Nodes:</div>
      {Object.keys(styles.visibleNodes).map((node) => (
        <Checkbox
          key={node}
          checked={styles.visibleNodes[node]}
          onChange={(e) =>
            setStyles({
              ...styles,
              visibleNodes: {

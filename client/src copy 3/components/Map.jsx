...
const Map = ({
  ...
  return (
    ...
    >
      ...
      {/* All masked content */}
      <g clipPath="url(#maskShape)">
        {/* ⬇️ Background image (optional, only render if you want) */}
        <image
          href="https://picturethestars.com/wp-content/themes/picture-the-stars/images/milky_small_black.jpg?v=2"
          x="0"
          y="0"
          width="1200"
          height="1200"
        ...
        {/* Projection background (color if needed) */}
        {createProjectionBackground()}
